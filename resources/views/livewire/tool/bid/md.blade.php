<div>
        ...
        <div class="flex justify-between mb-1">
            ...
            <div class="relative w-20">
                <div class="flex absolute bottom-0 right-0 cursor-pointer" wire:click="$emit('cancelOfferModal')">
                    <p class="text-sm font-bold text-blue-400">입찰취소</p><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#7FC7FD" stroke-width="4" stroke-linecap="round" stroke-linejoin="round"><path d="M9 18l6-6-6-6"/></svg>
                </div>
            </div>
        </div>
    @else
    ...
    @endif
    <input type="text" class="{{$showInput ? '' : 'hidden'}} border-gray-300 focus:border-green-700 focus:ring focus:ring-green-700 focus:ring-opacity-50 rounded-md shadow-sm w-full mt-1" wire:model.lazy="offerAmount" wire:keydown.enter="submit" placeholder="제시금액" />
