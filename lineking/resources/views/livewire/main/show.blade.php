<div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
    ...
    @if($totalRecords>0)
        <div class="m-3 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6 sm:m-0">
        @foreach($results as $result)
            <a href="{{ route('details',['id'=>$result->id])}}" target="_blank">
                <div class="transform hover:-translate-y-2 duration-200 hover:shadow-xl rounded-lg">
                    ...
                    <div class="grid grid-cols-2 bg-green-700 rounded-b-lg p-4 text-white">
                        ...
                        <div>
                            ...
                            <p class="text-2xl">{{number_format($result->maximumCost)}}<span class="text-sm">원</span></p>
                        </div>
                    </div>
                </div>
            </a>
